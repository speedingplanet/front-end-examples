...
// Array.prototype.toSpliced() does not modify the original array
// Instead, it returns a new modified array
// let modifiedArray = states.toSpliced(start, length?, replacement?);
// Delete two elements
let shorterStates = states.toSpliced(1, 2);

// Insert three elements at position 2
let replacedStates = states.toSpliced(2, 0, 'AR', 'AZ', 'CO');

// Replace the element at position 4
let delaware = states.toSpliced(4, 1, 'DE');
...
// The same, but returning a new sorted array, relatively new
let sortedStates = states.toSorted();

// If you can't use toSorted(), try this trick
let sortedStatesOld = [...states].sort();
...
/*
Sort alphabetically by lastName, using String.prototype.localeCompare()
